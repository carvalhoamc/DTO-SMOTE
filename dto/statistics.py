...
class Statistics:
    ...
    def rank_by_algorithm(self, df, tipo, wd, reducao, order, alpha):
        ...
        for name, group in df_temp:
            ...
            pre = df_pre[['ORIGINAL', 'SMOTE', 'SMOTE_SVM', 'BORDERLINE1', 'BORDERLINE2', 'DELAUNAY']]
            rec = df_rec[['ORIGINAL', 'SMOTE', 'SMOTE_SVM', 'BORDERLINE1', 'BORDERLINE2', 'DELAUNAY']]
            spe = df_spe[['ORIGINAL', 'SMOTE', 'SMOTE_SVM', 'BORDERLINE1', 'BORDERLINE2', 'DELAUNAY']]
            f1 = df_f1[['ORIGINAL', 'SMOTE', 'SMOTE_SVM', 'BORDERLINE1', 'BORDERLINE2', 'DELAUNAY']]
            geo = df_geo[['ORIGINAL', 'SMOTE', 'SMOTE_SVM', 'BORDERLINE1', 'BORDERLINE2', 'DELAUNAY']]
            iba = df_iba[['ORIGINAL', 'SMOTE', 'SMOTE_SVM', 'BORDERLINE1', 'BORDERLINE2', 'DELAUNAY']]
            auc = df_auc[['ORIGINAL', 'SMOTE', 'SMOTE_SVM', 'BORDERLINE1', 'BORDERLINE2', 'DELAUNAY']]
            ...
            # grafico CD
            identificadores = ['ORIGINAL', 'SMOTE', 'SMOTE_SVM', 'BORDERLINE1', 'BORDERLINE2', delaunay_type]
    ...
    def rank_total_by_algorithm(self, tipo, wd, reducao, order, alpha):
        ...
        cols = ['ALGORITHM','RANK_ORIGINAL','RANK_SMOTE','RANK_SMOTE_SVM','RANK_BORDERLINE1','RANK_BORDERLINE2','RANK_DELAUNAY']
